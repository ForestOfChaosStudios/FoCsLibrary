using ForestOfChaosLibrary.Base.HiddenClasses;
using UnityEngine;

namespace ForestOfChaosLibrary
{
	public abstract class FoCsBehaviour: FoCsInternalBehaviour
	{
	...
	public abstract class FoCs2DBehavior: FoCsInternalBehaviour
	{
