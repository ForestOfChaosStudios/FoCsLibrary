...
#region RawObjectField
		...
		public static eObject RawObjectField(Rect rect, string label,  Object value, Type type, bool allowSceneObjects) => RawObjectFieldMaster(rect, new GUICon(label), value, type, allowSceneObjects);
		public static eObject RawObjectField(Rect rect, GUICon guiCon, Object value, Type type, bool allowSceneObjects) => RawObjectFieldMaster(rect, guiCon,            value, type, allowSceneObjects);
...
#region ObjectFieldGeneric
		public static GUIEvent<T> ObjectField<T>(Rect rect, T      value,  Type type,  bool allowSceneObjects) where T: Object => ObjectFieldMaster(rect,            GUICon.none,       value, type, allowSceneObjects);
		public static GUIEvent<T> ObjectField<T>(Rect rect, string label,  T    value, Type type, bool allowSceneObjects) where T: Object => ObjectFieldMaster(rect, new GUICon(label), value, type, allowSceneObjects);
		public static GUIEvent<T> ObjectField<T>(Rect rect, GUICon guiCon, T    value, Type type, bool allowSceneObjects) where T: Object => ObjectFieldMaster(rect, guiCon,            value, type, allowSceneObjects);
...
#region PropertyField
		...
		public static eProp PropertyField(Rect pos, SerProp prop) => PropFieldMaster(pos, prop, new GUICon(prop.displayName), prop.isExpanded, AttributeCheck.DontCheck, false);
